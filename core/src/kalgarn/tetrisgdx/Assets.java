...
public class Assets {
    ...
    public static void load(){
        ...
        texture = new Texture(Gdx.files.internal("main-screen.png"));
        texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
        ...
        font = new BitmapFont(Gdx.files.internal("ubuntu-mono-48.fnt"),
                Gdx.files.internal("ubuntu-mono-48.png"), false);
    }
